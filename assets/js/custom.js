      ...
      if (c_name === "" || c_email === "" || c_message === "" || !isValidEmailAddress(c_email)) {
        ...
        $.ajax({
          ...
          data: {
            ...
            Subject: c_name,
            Body: "Email From: " + c_email + "Message: " + c_message
          },
          dataType: "json"
        })
          .done(function (data) {
          ...
          .fail(function (jqXHR, textStatus) {
            ...
            response.html('<i class="fa fa-warning"></i> Something went wrong! Please email at <b><a href="mailto:rabbyalone@gmail.com">rabbyalone@gmail.com</a></b>');
            $(".spinner").hide();
          });
      }
    });
